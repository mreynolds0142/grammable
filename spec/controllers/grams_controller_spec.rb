...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy action" do
    ...
    it "shouldn't let unauthenticated users destroy a gem" do
      gram = FactoryGirl.create(:gram)
      delete :destroy, params: { id: gram.id}
  ...
  describe "grams#update action" do
    it "shouldnt let users who didn't create the gram update it" do
    gram = FactoryGirl.create(:gram)
    user = FactoryGirl.create(:user)
    sign_in user
    ...
    it "shouldn't let unauthenticated users create a gem" do
      gram = FactoryGirl.create(:gram)
  ...
  describe "grams#edit action" do
    ...
    it "shouldn't let unauthenticated users edit a gem" do
      gram = FactoryGirl.create(:gram)
      get :edit, params: { id: gram.id }
      expect(response).to redirect_to new_user_session_path
    end
